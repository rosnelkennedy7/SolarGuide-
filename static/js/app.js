...
function genererRapport() {
  ...
  rapport.document
    .write(`<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>HélioBénin — Dimensionnement solaire PV</title>
        ...
        <div class="no-print" style="background:#166534;color:#fff;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;position:sticky;top:0;z-index:100;"><span style="font-weight:bold;">☀️ HélioBénin — Rapport ${refStr}</span><button onclick="window.print()" style="background:#fff;color:#166534;border:none;padding:8px 20px;border-radius:6px;font-weight:bold;cursor:pointer;font-size:11pt;">🖨️ Imprimer / Sauvegarder PDF</button></div>
        <div class="page"><div class="entete"><div class="entete-logo">☀️ HélioBénin</div><div class="entete-ref">Réf. ${refStr}<br>${dateStr} à ${heureStr}</div></div>
        ...
        <div class="pied"><span>☀️ HélioBénin · solarguide.bj</span><span>Page 1</span></div></div>
        <div class="page"><div class="entete"><div class="entete-logo">☀️ HélioBénin</div><div class="entete-ref">Réf. ${refStr}</div></div>
        ...
        <div class="pied"><span>☀️ HélioBénin · solarguide.bj</span><span>Page 2</span></div></div>
        <div class="page"><div class="entete"><div class="entete-logo">☀️ HélioBénin</div><div class="entete-ref">Réf. ${refStr}</div></div>
        ...
        <div class="pied"><span>☀️ HélioBénin · solarguide.bj</span><span>Page 3</span></div></div>
        <div class="page"><div class="entete"><div class="entete-logo">☀️ HélioBénin</div><div class="entete-ref">Réf. ${refStr}</div></div>
        ...
        <div class="pied"><span>☀️ HélioBénin · solarguide.bj</span><span>Page 4</span></div></div>
        <div class="page"><div class="entete"><div class="entete-logo">☀️ HélioBénin</div><div class="entete-ref">Réf. ${refStr}</div></div>
        ...
        <div style="text-align:center;margin-top:20px;padding-top:12px;border-top:1px solid #e0e0e0;"><div style="font-size:14pt;font-weight:bold;color:#166534;">☀️ HélioBénin</div><div style="font-size:9pt;color:#888;margin-top:4px;">© ${now.getFullYear()} HélioBénin — Tous droits réservés</div></div>
        <div class="pied"><span>☀️ HélioBénin · solarguide.bj</span><span>Page 5</span></div></div>
        </body></html>`);
